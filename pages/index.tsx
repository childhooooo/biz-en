...
import { Page, Stacked, Columns, Block, Figure, PlainText } from 'unflexible-ui';
import { Header, Footer } from 'components/layout';
import { Link, Parallax } from 'components/container';
import { MainVisual } from 'components/block';
import { Title02, Button01, ServiceLink } from 'components/element';
import { color } from 'lib/config';

import { view, config } from 'unflexible-ui';
...
const Home: NextPage = ({}: Props) => {
  return (
    ...
    >
      ...
      <Stacked paddingSize="narrow" isSection>
        <Link href={view.url('')}>
          <Stacked paddingSize="thin" wrap>
            <Columns align="center" gap="narrow">
              ...
              <Block>
                <PlainText h2SizeXL="1rem" h2SizeL="1rem" h2SizeM="1rem" h2SizeS="1rem" h2SizeXS="1rem" h2Weight="400">
      ...
      <Stacked color={color.theme} wrap isSection>
        <Columns justify="center">
          <Block width="80%">
            <Columns repeat={2} gap="wide">
              <Block>
                <Button01 name="求職者登録はこちら" kind="link" href={view.url('')} />
              </Block>

              <Block>
                <Button01 name="求人企業登録はこちら" kind="link" href={view.url('')} />
              </Block>
            </Columns>
          </Block>
        </Columns>
      ...
      <Stacked paddingPos="none" isSection>
        ...
        <Stacked paddingPos="none">
          ...
          >
            <PlainText baseAlign="center" baseLineHeight="2" h2Align="center" h2Weight="400" h2Color={color.gold}>
              <h2>
                地域産業に外国人材パワーを提供<br/>
                初期費用0円の外国人材紹介サービス
              </h2>
      ...
      <Stacked paddingPos="bottom" paddingSize="normal" isSection>
        ...
        <Stacked paddingPos="none" isSection>
          ...
          <Stacked paddingPos="none">
            <Link href={view.url('')}>
              <Figure
                img={view.url('images/index_contact@1500.jpg')}
