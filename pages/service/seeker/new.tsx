...
const ServiceSeekerNewPage: NextPage = ({}: Props) => {
  ...
  return (
    <Page
      title="会員登録 | 縁 -en-"
      description=""
      path="/service/seeker/new"
      ogType="article"
      header={(
        <Header
          title="会員登録 | 外国人材群馬支援事業（株式会社ビズソリューションズ）"
          language="ja"
        />
      )}
      footer={<Footer/>}
    ...
    >
      ...
      <Stacked paddingPos="top" paddingSize="narrow" isSection wrap>
        <Stacked paddingPos="none">
          <IconButton01 name="求職者登録でできること" kind="link" href={view.url('service/seeker')} icon={view.url('images/icon_family.png')} />
        </Stacked>
