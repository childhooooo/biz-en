...
const ServiceApplicantPage: NextPage = ({}: Props) => {
  const routes = [
    { name: 'TOP', href: view.url('') },
    { name: 'About us', href: view.url('about') },
    { name: '求職者登録でできること', href: view.url('service/applicant') }
  ];
  ...
  return (
    ...
    >
        ...
        <Columns justify="center" gap="normal" wrapXL="nowrap">
          ...
          <Block shrink={2}>
            ...
            <Stacked paddingPos="top" paddingSize="narrow">
              <PlainText baseSizeXL="1.5rem" baseColor={color.textBlue} baseLineHeight="1.5">
      ...
      <Stacked wrap>
        <Columns justify="center">
          <Button02 name="求職者登録はこちら" kind="link" href={view.url('applicant/new')} />
        </Columns>
      </Stacked>
    </Page>
  );
...
export default ServiceApplicantPage;
