...
const ServiceMatchingSeekerEditRequestNewPage: NextPage = () => {
  return (
    <AuthStateProvider>
      <ServiceMatchingSeekerEditRequestNewContents />
    </AuthStateProvider>
  );
}

const ServiceMatchingSeekerEditRequestNewContents: NextPage = () => {
  ...
  return (
    ...
    >
      ...
      <Stacked isSection wrap>
        ...
        {seekerAuthState.seekerId.value === null &&
          <>
